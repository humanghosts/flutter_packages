...
class _ResponsiveScaffoldState extends State<ResponsiveScaffold> {
  ...
  void didUpdateWidget(covariant ResponsiveScaffold oldWidget) {
    ...
    if (media.size != mediaSize) {
      ...
      final bool isPhone = media.size.width < 600;
                    ...
                    child: Row(
                      children: <Widget>[
                        MaybeTooltip(
                          ...
                          condition: (width == railWidth || label != tooltip) && tooltip != '' && enabled,
        ...
        ListTile(
          ...
          leading: CircleAvatar(
            ...
            child: Text(
              ...
              style: primaryTextTheme.subtitle1!.copyWith(color: theme.colorScheme.onPrimary, fontWeight: FontWeight.w600),
            ),
          ),
