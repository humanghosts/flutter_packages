...
class ColorSchemePopupMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String colorName = enabled && !useDefault ? SchemeColor.values[index].name : labelForDefault;
...
class ColorSchemeBox extends StatelessWidget {
  ...
  static Color _onColor(final Color color) => _isLight(color) ? Colors.black.withOpacity(0.4) : Colors.white.withOpacity(0.4);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Material(
        ...
        child: defaultColor ? Icon(Icons.texture_outlined, color: _onColor(color)) : Icon(Icons.palette_outlined, color: _onColor(color)),
      ),
    );
  }
}
