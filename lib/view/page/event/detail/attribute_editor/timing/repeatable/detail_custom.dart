...
class RepeatableTimingDetailCustomLogic extends TimingDetailCustomLogic<RepeatableTiming> {
  /// 重复规则更新标识
...
class RepeatableTimingDetailCustom extends TimingDetailCustom<RepeatableTiming, RepeatableTimingDetailCustomLogic> {
  RepeatableTimingDetailCustom({
    required String key,
    required TimingDetailCustomArgs args,
    required TimingDetailCustomDataSource<RepeatableTiming> dataSource,
  }) : super(key: key, args: args, dataSource: dataSource, newLogic: RepeatableTimingDetailCustomLogic());
