...
class RepeatableTimingDetailTimeLogic extends TimingDetailTimeLogic<RepeatableTiming> {
  /// 重复规则更新标识
...
class RepeatableTimingDetailTime extends TimingDetailTime<RepeatableTiming, RepeatableTimingDetailTimeLogic> {
  RepeatableTimingDetailTime({
    required String key,
    required TimingDetailTimeArgs args,
    required TimingDetailTimeDataSource<RepeatableTiming> dataSource,
  }) : super(key: key, args: args, dataSource: dataSource, newLogic: RepeatableTimingDetailTimeLogic());
