...
class ThemeController with ChangeNotifier {
  Future<void> loadAll() async {
    ...
    _useFlexColorScheme = await _themeService.load(Store.keyUseFlexColorScheme, Store.defaultUseFlexColorScheme);
    ...
    _useDarkColorsForSeed = await _themeService.load(Store.keyUseDarkColorsForSeed, Store.defaultUseDarkColorsForSeed);
    ...
    _navBarSelectedSchemeColor = await _themeService.load(Store.keyNavBarSelectedItemSchemeColor, Store.defaultNavBarSelectedItemSchemeColor);
    ...
    _navigationRailElevation = await _themeService.load(Store.keyNavigationRailElevation, Store.defaultNavigationRailElevation);
    _navRailSelectedSchemeColor = await _themeService.load(Store.keyNavRailSelectedItemSchemeColor, Store.defaultNavRailSelectedItemSchemeColor);
    ...
    _radioSchemeColor = await _themeService.load(Store.keyRadioSchemeColor, Store.defaultRadioSchemeColor);
    //
  ...
  Future<void> resetAllToDefaults() async {
    ...
    await setTooltipsMatchBackground(Store.defaultTooltipsMatchBackground, false);
    //
    // Surface and blend SETTINGS.
    ...
    await setToDarkSwapPrimaryAndContainer(Store.defaultToDarkSwapPrimaryAndContainer, false);
    ...
    await setKeepDarkPrimaryContainer(Store.defaultKeepDarkPrimaryContainer, false);
    await setKeepDarkSecondaryContainer(Store.defaultKeepDarkSecondaryContainer, false);
    await setKeepDarkTertiaryContainer(Store.defaultKeepDarkTertiaryContainer, false);
    ...
    //
    // InputDecorator SETTINGS.
    await setInputDecoratorSchemeColorLight(Store.defaultInputDecoratorSchemeColorLight, false);
    await setInputDecoratorSchemeColorDark(Store.defaultInputDecoratorSchemeColorDark, false);
    await setInputDecoratorIsFilled(Store.defaultInputDecoratorIsFilled, false);
    await setInputDecoratorBorderType(Store.defaultInputDecoratorBorderType, false);
    await setInputDecoratorBorderRadius(Store.defaultInputDecoratorBorderRadius, false);
    await setInputDecoratorUnfocusedHasBorder(Store.defaultInputDecoratorUnfocusedHasBorder, false);
    await setInputDecoratorUnfocusedBorderIsColored(Store.defaultInputDecoratorUnfocusedBorderIsColored, false);
    //
    // AppBar SETTINGS.
    ...
    await setAppBarBackgroundSchemeColorLight(Store.defaultAppBarBackgroundSchemeColorLight, false);
    await setAppBarBackgroundSchemeColorDark(Store.defaultAppBarBackgroundSchemeColorDark, false);
    //
    // TabBar SETTINGS.
    ...
    await setTabBarItemSchemeColorLight(Store.defaultTabBarItemSchemeColorLight, false);
    await setTabBarItemSchemeColorDark(Store.defaultTabBarItemSchemeColorDark, false);
    //
    // BottomSheet SETTINGS.
    await setBottomSheetBorderRadius(Store.defaultBottomSheetBorderRadius, false);
    //
    // Android System Navigator bar SETTINGS.
    ...
    //
    // BottomNavigationBar SETTINGS.
    await setBottomNavBarBackgroundSchemeColor(Store.defaultBottomNavBarBackgroundSchemeColor, false);
    await setBottomNavigationBarOpacity(Store.defaultBottomNavigationBarOpacity, false);
    await setBottomNavigationBarElevation(Store.defaultBottomNavigationBarElevation, false);
    await setBottomNavBarSelectedSchemeColor(Store.defaultBottomNavBarSelectedItemSchemeColor, false);
    await setBottomNavBarUnselectedSchemeColor(Store.defaultBottomNavBarUnselectedSchemeColor, false);
    await setBottomNavBarMuteUnselected(Store.defaultBottomNavBarMuteUnselected, false);
    await setBottomNavShowSelectedLabels(Store.defaultBottomNavShowSelectedLabels, false);
    await setBottomNavShowUnselectedLabels(Store.defaultBottomNavShowUnselectedLabels, false);
    //
    // NavigationBar SETTINGS.
    await setNavBarBackgroundSchemeColor(Store.defaultNavBarBackgroundSchemeColor, false);
    await setNavBarOpacity(Store.defaultNavBarOpacity, false);
    await setNavBarHeight(Store.defaultNavBarHeight, false);
    await setNavBarSelectedSchemeColor(Store.defaultNavBarSelectedItemSchemeColor, false);
    await setNavBarUnselectedSchemeColor(Store.defaultNavBarUnselectedSchemeColor, false);
    await setNavBarMuteUnselected(Store.defaultNavBarMuteUnselected, false);
    await setNavBarIndicatorSchemeColor(Store.defaultNavBarIndicatorSchemeColor, false);
    ...
    //
    // NavigationRail SETTINGS.
    await setNavRailBackgroundSchemeColor(Store.defaultNavRailBackgroundSchemeColor, false);
    await setNavRailOpacity(Store.defaultNavRailOpacity, false);
    await setNavigationRailElevation(Store.defaultNavigationRailElevation, false);
    await setNavRailSelectedSchemeColor(Store.defaultNavRailSelectedItemSchemeColor, false);
    await setNavRailUnselectedSchemeColor(Store.defaultNavRailUnselectedSchemeColor, false);
    ...
    await setNavRailIndicatorSchemeColor(Store.defaultNavRailIndicatorSchemeColor, false);
    await setNavRailIndicatorOpacity(Store.defaultNavRailIndicatorOpacity, false);
    //
    // Button SETTINGS.
    ...
    await setElevatedButtonSchemeColor(Store.defaultElevatedButtonSchemeColor, false);
    await setElevatedButtonBorderRadius(Store.defaultElevatedButtonBorderRadius, false);
    await setOutlinedButtonSchemeColor(Store.defaultOutlinedButtonSchemeColor, false);
    await setOutlinedButtonBorderRadius(Store.defaultOutlinedButtonBorderRadius, false);
    await setToggleButtonsSchemeColor(Store.defaultToggleButtonsSchemeColor, false);
    await setToggleButtonsBorderRadius(Store.defaultToggleButtonsBorderRadius, false);
    //
    // Toggleable SETTINGS.
    await setUnselectedToggleIsColored(Store.defaultUnselectedToggleIsColored, false);
    ...
    await setDialogBackgroundSchemeColor(Store.defaultDialogBackgroundSchemeColor, false);
  ...
  Future<void> resetCustomColorsToDefaults() async {
    ...
    await setSecondaryContainerLight(Store.defaultSecondaryContainerLight, false);
  ...
  Future<void> setSurfaceModeLight(FlexSurfaceMode? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setSurfaceModeDark(FlexSurfaceMode? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setUseDarkColorsForSeed(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setToDarkSwapPrimaryAndContainer(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setKeepPrimaryContainer(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setKeepSecondaryContainer(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setKeepTertiaryContainer(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setKeepDarkPrimaryContainer(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setKeepDarkSecondaryContainer(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setKeepDarkTertiaryContainer(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setInputDecoratorSchemeColorLight(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setInputDecoratorSchemeColorDark(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setInputDecoratorBorderRadius(double? value, [bool notify = true]) async {
  ...
  Future<void> setInputDecoratorUnfocusedBorderIsColored(bool? value, [bool notify = true]) async {
    if (value == null) return;
    if (value == _inputDecoratorUnfocusedBorderIsColored) return;
    _inputDecoratorUnfocusedBorderIsColored = value;
    if (notify) notifyListeners();
    await _themeService.save(Store.keyInputDecoratorUnfocusedBorderIsColored, value);
  }
  ...
  Future<void> setAppBarStyleLight(FlexAppBarStyle? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setAppBarStyleDark(FlexAppBarStyle? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setAppBarOpacityLight(double? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setAppBarElevationLight(double? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setAppBarElevationDark(double? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setAppBarBackgroundSchemeColorLight(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setAppBarBackgroundSchemeColorDark(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setTabBarIndicatorLight(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setTabBarIndicatorDark(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setTabBarItemSchemeColorLight(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setTabBarItemSchemeColorDark(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setBottomSheetBorderRadius(double? value, [bool notify = true]) async {
  ...
  Future<void> setSysNavBarStyle(FlexSystemNavBarStyle? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setBottomNavBarBackgroundSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setBottomNavBarSelectedSchemeColor(SchemeColor? value, [bool notify = true]) async {
    if (value == _bottomNavBarSelectedSchemeColor) return;
    _bottomNavBarSelectedSchemeColor = value;
    if (notify) notifyListeners();
    await _themeService.save(Store.keyBottomNavBarSelectedItemSchemeColor, value);
  }
  ...
  Future<void> setBottomNavBarUnselectedSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setBottomNavBarMuteUnselected(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setBottomNavShowSelectedLabels(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setBottomNavShowUnselectedLabels(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setNavBarBackgroundSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setNavBarSelectedSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setNavBarUnselectedSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setNavBarMuteUnselected(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setNavBarIndicatorSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setNavBarIndicatorOpacity(double? value, [bool notify = true]) async {
  ...
  Future<void> setNavBarLabelBehavior(NavigationDestinationLabelBehavior value, [bool notify = true]) async {
  ...
  Future<void> setNavRailBackgroundSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setNavigationRailElevation(double? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setNavRailSelectedSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setNavRailUnselectedSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setNavRailMuteUnselected(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setNavRailLabelType(NavigationRailLabelType value, [bool notify = true]) async {
  ...
  Future<void> setNavRailIndicatorSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setNavRailIndicatorOpacity(double? value, [bool notify = true]) async {
  ...
  Future<void> setTextButtonSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setTextButtonBorderRadius(double? value, [bool notify = true]) async {
  ...
  Future<void> setElevatedButtonSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setElevatedButtonBorderRadius(double? value, [bool notify = true]) async {
  ...
  Future<void> setOutlinedButtonSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setOutlinedButtonBorderRadius(double? value, [bool notify = true]) async {
  ...
  Future<void> setToggleButtonsSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setToggleButtonsBorderRadius(double? value, [bool notify = true]) async {
  ...
  Future<void> setUnselectedToggleIsColored(bool? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setSwitchSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setCheckboxSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setRadioSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setFabSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setChipSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setSnackBarSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setPopupMenuBorderRadius(double? value, [bool notify = true]) async {
  ...
  Future<void> setDialogBackgroundSchemeColor(SchemeColor? value, [bool notify = true]) async {
  ...
  Future<void> setDialogBorderRadius(double? value, [bool notify = true]) async {
  ...
  Future<void> setPrimaryContainerLight(Color? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setSecondaryContainerLight(Color? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setTertiaryContainerLight(Color? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setPrimaryContainerDark(Color? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setSecondaryContainerDark(Color? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setTertiaryContainerDark(Color? value, [bool notify = true]) async {
    if (value == null) return;
  ...
  Future<void> setHoverTonalPalette(TonalPalettes? value, [bool notify = true]) async {
