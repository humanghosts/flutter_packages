...
extension FlexColorSchemeConvert on ThemeTemplate {
  ...
  FlexSchemeColor toFlexSchemeColor({Brightness? brightness}) {
    return (brightness ?? ThemeHelper().brightness) == Brightness.light ? toFlexSchemeColorLight() : toFlexSchemeColorDark();
  }

  FlexColorScheme toFlexColorTheme({Brightness? brightness}) {
    return (brightness ?? ThemeHelper().brightness) == Brightness.light ? toFlexColorThemeLight() : toFlexColorThemeDark();
  }
