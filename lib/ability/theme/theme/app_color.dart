    ...
    if (index == schemes.length - 1) {
      return controller.customScheme.copyWith(
          dark: controller.useKeyColors
              ? controller.useDarkColorsForSeed && (index == 0 || index == 1 || index == 2 || index == AppColor.schemes.length - 1)
                  ? controller.customScheme.dark
                  : controller.customScheme.light
              : controller.useToDarkMethod
                  ? controller.customScheme.light.defaultError.toDark(controller.darkMethodLevel, controller.toDarkSwapPrimaryAndContainer)
                  : null);
    }
    return schemes[index].copyWith(
        dark: controller.useKeyColors
            ? controller.useDarkColorsForSeed && (index == 0 || index == 1 || index == 2 || index == AppColor.schemes.length - 1)
                ...
                : schemes[index].light
            : controller.useToDarkMethod
                ? schemes[index].light.defaultError.toDark(controller.darkMethodLevel, controller.toDarkSwapPrimaryAndContainer)
                : null);
  }
