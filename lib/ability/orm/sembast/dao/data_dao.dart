...
import 'package:hg_framework/ability/orm/cache/cache.dart';
import 'package:hg_framework/ability/orm/database.dart';
...
class SembastDataDao<T extends DataModel> extends api.DataDao<T> {
  ...
  /// 获取数据库实例
  Database get dataBase => (DatabaseHelper.instance.database as SembastDatabase).database;
