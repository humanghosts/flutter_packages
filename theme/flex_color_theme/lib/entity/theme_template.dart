...
import 'package:hgs_framework/app/app.dart';
...
extension FlexColorSchemeConvert on ThemeTemplate {
  ...
  FlexSchemeColor toFlexSchemeColor({Brightness? brightness}) {
    return (brightness ?? themeConfig.brightness) == Brightness.light ? toFlexSchemeColorLight() : toFlexSchemeColorDark();
  }

  FlexColorScheme toFlexColorTheme({Brightness? brightness}) {
    return (brightness ?? themeConfig.brightness) == Brightness.light ? toFlexColorThemeLight() : toFlexColorThemeDark();
  }
